...
arx_fit = sysoe.Report.Fit.FitPercent;
...
pzmap(sysoe);
figure
bode(sysoe,sysarxl,sysarxh),legend('white noise input','low pass input','high pass input');
[p,z]=pzmap(sysoe);
a=angle(p);
save real_problem_2;