...
arx_fit = sysbj.Report.Fit.FitPercent;
...
pzmap(sysbj);
figure
bode(sysbj,sysarxl,sysarxh),legend('white noise input','low pass input','high pass input');
[p,z]=pzmap(sysbj);
a=angle(p);
save real_problem_2;